...
const motorizedblinds = () => {
  return (<>
    ...
    <div className='px-24 space-y-10 pt-20 pb-10'>
      ...
      <Slide left><div style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        ...
        <div className='p-5 space-y-8'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Varied Control Options Include Remotes, and Apps</h1>
          <p className='text-sm leading-relaxed pr-8 '>You can control your motorized blinds with either a wall-mounted wireless switch, a remote control or an app. It is wise to have a wall-mounted switch or remote on hand so anyone can adjust the motorized window blind when needed.
      ...
      <Slide right><div id="bedroom" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div className='p-5 space-y-10'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Bedroom</h1>
          <p className='text-sm leading-relaxed pr-8 '>Window treatments for the bedroom are usually poised to serve more than an aesthetic purpose. From blackout shades to layered drapes, the functionality here is all about creating a soothing ambiance for a restful night’s (and morning’s!) sleep.
      ...
      <Slide right>
        <div id="bathroom" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
          <div className='p-5 space-y-10'>
            <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Bathroom</h1>
            <p className='text-sm leading-relaxed pr-8 '>Bathroom windows are a fickle sort. There are those that span from wall to wall, the dreamy picture window set behind a freestanding tub, or the narrow strips high up on the wall which, let’s face it, are better than nothing. Anything faux wood or water will be the best window blinds for the bathroom.
