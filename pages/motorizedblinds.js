...
const [sw, setsw] = useState(false);
  ...
  return (<>
    ...
    <div style={sw?{padding:"6.275vw 7.5vw 3.125vw",marginTop:"4vw"}:{padding:"6.275vh 7.5vw 3.125vh",marginTop:"4vh"}} className='px-24 pt-20 pb-10'>
      ...
      <Slide left><div style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex ">
      ...
      <Slide right><div style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div style={sw?{padding:"1.56vw"}:{padding:"1.56vh"}} className='p-5 space-y-8'>
          <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw "}:{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh "}} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Automation Settings Adds Security When You Are Away from Home</h1>
          <p style={sw?{fontSize:"1.1vw",marginTop:"2.5vw",paddingRight:"2.5vw",lineHeight:"1.6vw "}:{fontSize:"1.1vh",marginTop:"1.5vh",paddingRight:"2.5vh",lineHeight:"1.6vh "}} className='text-sm leading-relaxed pr-8 '>Since motorized window blinds can operate automatically throughout the day they will make it seem like someone is home, even if you are thousands of miles away. Motorized window blinds are more of a deterrent to potential thieves than any other window covering, especially when coupled with an automated smart home lighting system.
      ...
      <Slide left><div style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        ...
        <div style={sw?{padding:"1.56vw"}:{padding:"1.56vh"}} className='p-5 space-y-8'>
          <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw "}:{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh "}} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Varied Control Options Include Remotes, and Apps</h1>
          <p style={sw?{fontSize:"1.1vw",marginTop:"2.5vw",paddingRight:"2.5vw",lineHeight:"1.6vw "}:{fontSize:"1.1vh",marginTop:"1.5vh",paddingRight:"2.5vh",lineHeight:"1.6vh "}} className='text-sm leading-relaxed pr-8 '>You can control your motorized blinds with either a wall-mounted wireless switch, a remote control or an app. It is wise to have a wall-mounted switch or remote on hand so anyone can adjust the motorized window blind when needed.
      ...
      <Slide left> <div id="living" style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" ,marginTop:"4vw"}:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" ,marginTop:"4vh"}} className="flex">
        {sw && <img src='/pexels-max-vakhtbovych-7533758.jpg' className='h-full w-3/6' alt='img'></img>}
        <div className='p-5 space-y-10'>
          <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif",fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw " }:{ fontFamily: "'Fjalla One', sans-serif",fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh " }} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Living Area</h1>
          <p style={sw?{fontSize:"1.1vw",marginTop:"2.5vw",paddingRight:"2.5vw",lineHeight:"1.6vw "}:{fontSize:"1.1vh",marginTop:"1.5vh",paddingRight:"2.5vh",lineHeight:"1.6vh "}} className='text-sm leading-relaxed pr-8 '>When picking the best window treatment for the living or dining room, you have more flexibility than, say, the bathroom or kitchen, and much of it rides on personal preferences. If you’re looking to keep things modern and minimalist, shades are probably the way to go. Sheer curtains will invite an almost ethereal element, while heavy, layered drapes will run more traditional. Triple shade blinds & honeycomb blinds give that hotel like look to your living area. Can’t decide? A combination of curtains and shades are always welcome.

          </p>
        </div>
      </div></Slide>
      <Slide right><div id="bedroom" style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div className='p-5 space-y-10'>
          <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw "}:{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh "}} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Bedroom</h1>
      ...
      <Slide left>
        <div id="kitchen" style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
          {sw && <img src='/pexels-max-vakhtbovych-7614610 (1).jpg' className='h-full w-3/6' alt='img'></img>}
          <div className='p-5 space-y-10'>
            <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw "}:{ fontFamily: "'Fjalla One', sans-serif" ,fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh "}} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Kitchen</h1>
            <p style={sw?{fontSize:"1.1vw",marginTop:"2.5vw",paddingRight:"2.5vw",lineHeight:"1.6vw "}:{fontSize:"1.1vh",marginTop:"1.5vh",paddingRight:"2.5vh",lineHeight:"1.6vh "}} className='text-sm leading-relaxed pr-8 '>Choosing the best window treatment for the kitchen could entail a variety of shapes and sizes. You can have a floor-to-ceiling window on one end of the room and a spanning picture window above the sink. Making sure your picks visually align will make quite an impact. Durability is yet another important consideration.
      ...
      <Slide right>
        <div id="bathroom" style={sw?{marginBottom:"4vw", height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }:{marginBottom:"4vh", height: "61vw", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
          <div className='p-5 space-y-10'>
            <h1 style={sw?{ fontFamily: "'Fjalla One', sans-serif",fontSize:"2.35vw",marginTop:"2.5vw",lineHeight:"2.5vw " }:{ fontFamily: "'Fjalla One', sans-serif",fontSize:"2.35vh",marginTop:"1.5vh",lineHeight:"2.5vh " }} className='text-3xl scale-y-125 mt-8  text-gray-800 uppercase'>Bathroom</h1>
            <p style={sw?{fontSize:"1.1vw",marginTop:"2.5vw",paddingRight:"2.5vw",lineHeight:"1.6vw "}:{fontSize:"1.1vh",marginTop:"1.5vh",paddingRight:"2.5vh",lineHeight:"1.6vh "}} className='text-sm leading-relaxed pr-8 '>Bathroom windows are a fickle sort. There are those that span from wall to wall, the dreamy picture window set behind a freestanding tub, or the narrow strips high up on the wall which, let’s face it, are better than nothing. Anything faux wood or water will be the best window blinds for the bathroom.
