    ...
    <div className='px-24 space-y-10 py-10'>
      ...
      <Slide left><div style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex ">
        ...
        <div className='p-5 space-y-8'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Cordless Design Offers Maximum<br></br> Safety for Children and Pets</h1>
      ...
      <Slide right><div style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div className='p-5 space-y-8'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Automation Settings Adds Security When <br></br>You Are Away from Home</h1>
      ...
      <Slide left><div style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        ...
        <div className='p-5 space-y-8'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Varied Control Options Include Remotes, and Apps</h1>
      ...
      <Slide left> <div id="living" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        ...
        <div className='p-5 space-y-10'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Living Area</h1>
      ...
      <Slide right><div id="bedroom" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div className='p-5 space-y-10'>
          <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Bedroom</h1>
      ...
      <Slide left>
        <div id="kitchen" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
          ...
          <div className='p-5 space-y-10'>
            <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Kitchen</h1>
      ...
      <Slide right>
        <div id="bathroom" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
          <div className='p-5 space-y-10'>
            <h1 style={{ fontFamily: "'Fjalla One', sans-serif" }} className='text-2xl scale-y-125 mt-8  text-gray-800 uppercase'>Bathroom</h1>
