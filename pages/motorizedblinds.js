...
const motorizedblinds = () => {
  return (<>
    ...
    <div className='px-24 space-y-10 py-10'>
      <div><img alt='img' src='https://www.mac.in/assets/site/images/product/MOTORISED-BLINDS/slider-1.jpg'></img></div>
      
      <div style={{fontFamily: "'Fjalla One', sans-serif"}} className='text-center text-5xl  '>MOTORIZED BLINDS</div>

      <div style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex ">
...
There are different apps you can use to control your motorized blinds, including Connector, an app specifically designed for the purpose ,such as Google Assistant or Amazon Alexa .
      ...
      <div id="living" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
      ...
      <div id="bedroom" style={{ height: "61vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex">
        <div className='p-5 space-y-10'>
