...
const About = () => {
  ...
  return (
    ...
    <div style={{fontFamily: "'Roboto Slab', serif"}}>
      ...
      <h1 style={{fontFamily: "'Fjalla One', sans-serif",letterSpacing:1.2}} className='2xl:text-7xl text-6xl font-bold w-full text-center absolute 2xl:my-60 md:my-56 z-30 text-gray-200  '>YOU IMAGINE, WE CREATE</h1>
