...
const Remotes = ({product,addToCart}) => {
  ...
  useEffect(() => {
    ...
    return (<>
      ...
      {Object.keys(product).map((p)=>{return <Slide left key={p}><div style={sw?{height: "61vh",fontSize:"1.5vw", fontFamily: "'Roboto Slab', serif" }:{height: "65vh",fontSize:"1.5vh", backgroundColor: "#ebeaeb", fontFamily: "'Roboto Slab', serif" }} className="flex md:flex-row flex-col w-full rhover">
